...
<div class="container" >
    <div class="row " >
        <div class="col-sm-3"> <font size="3">เลขที่ใบเตือน : <b>{{$warning_no}}</b></font>
            
        </div>
        <div class="col-sm-6 text-center align-self-center" >
            <h3><div id="reportcompany">Company</div></h3>
            <h4>หนังสือเตือน</h4>
        </div>
    ...
    <font size="3">
        <div class="row"style="height: 140px">
                <div class="col-md-9 offset-md-2 ">
                        <div id='penalty1'><i class="far fa-square"></i> ตักเตือนด้วยวาจา</div> 
                        <div id='penalty2'><i class="far fa-square"></i> ตักเตือนด้วยลายลักษณ์อักษร</div> 
                        <div id='penalty3'><i class="far fa-square"></i> พักงาน/ชดใช้ค่าเสียหาย</div> 
                        <div id='penalty4'><i class="far fa-square"></i> เลิกจ้าง</div>
                            {{-- <div id="penalty" name="penalty"></div> --}}
                        <div id='penalty4'><i class="far fa-square"></i> อื่นๆ  ...................................................................................................................................................</div>
                </div>
        </div>
    </font>
    <font size="4">
        ...
        <div class="row " style="height: 30px">
            ...
            <div class="col-sm"> (................................ผู้จัดการฝ่าย...............................)</div>
        </div>
                    ...
                    {   
                        ...
                        for (i=0; i < response.length ; i++) {
                            if (response[i].penalty_id == '1') {
                                $('#penalty1').html(' <b> <i class="far fa-check-square"></i> '+response[i].penalty_description+"</b> ");
                            } 
                            if (response[i].penalty_id == '2') {
                                $('#penalty2').html(' <b> <i class="far fa-check-square"></i> '+response[i].penalty_description+"</b> ");
                            } 
